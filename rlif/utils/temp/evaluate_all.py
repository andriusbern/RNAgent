...
from rlif.learning import Trainer
...
class Tester(object):
    ...
    def evaluate(self, method='rlif', time_limit=60, verbose=False, permute=False, show=True):
        """
        ...
        for i, dataset in enumerate(datasets):
            try:    
                if method == 'rlif':
                    results[i], desc = self.rlif_evaluation(
                        dataset=dataset, 
    ...
    def rlif_evaluation(self, dataset='rfam_learn_test', time_limit=60, permute=True, verbose=True):
