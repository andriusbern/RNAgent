! function(t, n) { "object" == typeof exports && "object" == typeof module ? module.exports = n() : "function" == typeof define && define.amd ? define([], n) : "object" == typeof exports ? exports.fornac = n() : t.fornac = n() }(this, function() {
    return function(t) {
        ...
        function o(t, n, e, i) {
            ...
            o.dotbracket = a.targetString, o.dotBracketBreaks = a.breaks, a = o.removeBreaks(o.seq), o.seq = a.targetString, o.seqBreaks = a.breaks, o.calculateStartNumberArray = function() { o.startNumberArray = []; for (var t = 0; t < o.dotbracket.length; t++) o.startNumberArray.push(i), "o" == o.dotbracket[t] && (i = -t) }, o.calculateStartNumberArray(), o.rnaLength = o.dotbracket.length, (0, u.arraysEqual)(o.dotBracketBreaks, o.seqBreaks) || (console.log("WARNING: DotBracket and structure breaks not equal"), console.log("WARNING: Using the breaks in the structure")), o.computePairtable(), o.addPositions = function(t, n) { for (var e = o.nodes.filter(function(n) { return n.nodeType == t }), r = 0; r < e.length; r++) e[r].x = n[r][0], e[r].px = n[r][0], e[r].y = n[r][1], e[r].py = n[r][1]; return o }, o.breakNodesToFakeNodes = function() { for (var t = o.nodes.filter(function(t) { return "nucleotide" == t.nodeType }), n = 0; n < t.length; n++) "o" == o.dotbracket[n] && (t[n].nodeType = "middle"); for (var n = 0; n < o.elements.length; n++) { for (var e = !1, r = 0; r < o.elements[n][2].length; r++) o.dotBracketBreaks.indexOf(o.elements[n][2][r]) >= 0 && (e = !0);
