...
class Spliceable(Solution):
    ...
    """
    def __init__(self, target, config, mismatches, string=None, time=None, source='rlif'):
        Solution.__init__(self, target, config, string=None, time=None, source='rlif')
    ...
    def compute_statistics(self):
        ...
        self.folded_structure, self.fe = fc.mfe()
        ...
        self.probability = fc.pr_structure(self.folded_structure)
        self.ensemble_diversity = fc.mean_bp_distance()
        self.ensemble_defect = fc.ensemble_defect(self.folded_structure)
